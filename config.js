...
module.exports = {
    VERSION: 'v4.0.0',
    ALIVE: process.env.ALIVE || "https://adxsmmpanel.store/img/files/122807cf322e4d1a8b6b00e6682408ed.jpg Hey {sender}, I'm alive \n Uptime: {uptime}",
    ...
    BOT_INFO: process.env.BOT_INFO || 'Raganork;Skl11;0;https://adxsmmpanel.store/img/files/122807cf322e4d1a8b6b00e6682408ed.jpg;https://wa.me/+35196187888',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "HYREX BOT WA",
    BOT_NAME: process.env.BOT_NAME || 'HYREX BOT',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'ꪶCODDED BY ADWAITHꫂ;HYREX MD bot;https://i.imgur.com/P7ziVhr.jpeg' : process.env.AUDIO_DATA,
